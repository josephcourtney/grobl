...
def test_resolve_table_style_auto(monkeypatch: pytest.MonkeyPatch) -> None:
    ...
    # Non-auto options should remain unchanged
    assert tty.resolve_table_style(TableStyle.COMPACT) is TableStyle.COMPACT
