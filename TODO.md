...
- [ ] Run the targeted config-pruning tests. Acceptance: unit, component, and CLI pruning tests pass under strict test-category enforcement.
- [ ] Run `just check`. Acceptance: every strict validation step passes after the pruning refinement.
